...
@Component({
  selector: 'app-result-bikerace',
  templateUrl: './result-bikerace.component.html',
  styleUrls: ['./result-bikerace.component.css']
})
export class ResultBikeraceComponent implements OnInit {
  ...
  onSelectionChanged(selectedRow, results: HTMLElement) {
    ...
    this.resultsService.getBikeRaceCompetitionTeamResults(this.selectedBikeRaceId, this.navService.selectedYear).subscribe((result: any) => {
      debugger;
      this.loadingVisible = false;
